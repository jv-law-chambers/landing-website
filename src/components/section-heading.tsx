...
export function SectionHeading({ title, suffix, className, subtitle, centered = false }: SectionHeadingProps) {
  return (
    <div className={cn("mb-10 md:mb-12", centered ? "text-center" : "text-left", className)}>
      <h2 className={cn("text-3xl md:text-4xl font-heading font-bold text-foreground", centered ? "inline-block" : "")}>
